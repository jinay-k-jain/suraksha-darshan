...
export const slotTemplates = [
  { label: '05:00 - 06:00 AM', status: 'few', available: 15, capacity: 100 },
  { label: '06:00 - 07:00 AM', status: 'available', available: 78, capacity: 100 },
  { label: '07:00 - 08:00 AM', status: 'available', available: 65, capacity: 100 },
  { label: '08:00 - 09:00 AM', status: 'filling', available: 42, capacity: 100 },
  { label: '09:00 - 10:00 AM', status: 'waitlist', available: 0, capacity: 100 },
  { label: '10:00 - 11:00 AM', status: 'available', available: 82, capacity: 100 },
  { label: '11:00 - 12:00 AM', status: 'few', available: 18, capacity: 100 },
  { label: '12:00 - 01:00 PM', status: 'available', available: 70, capacity: 100 },
  { label: '01:00 - 02:00 PM', status: 'available', available: 88, capacity: 100 },
  { label: '02:00 - 03:00 PM', status: 'filling', available: 35, capacity: 100 },
  { label: '03:00 - 04:00 PM', status: 'waitlist', available: 0, capacity: 100 },
  { label: '04:00 - 05:00 PM', status: 'available', available: 92, capacity: 100 },
  { label: '05:00 - 06:00 PM', status: 'available', available: 55, capacity: 100 },
  { label: '06:00 - 07:00 PM', status: 'filling', available: 28, capacity: 100 },
  { label: '07:00 - 08:00 PM', status: 'waitlist', available: 0, capacity: 100 },
  { label: '08:00 - 09:00 PM', status: 'available', available: 60, capacity: 100 },
  { label: '09:00 - 10:00 PM', status: 'waitlist', available: 0, capacity: 100 },
  { label: '10:00 - 11:00 PM', status: 'available', available: 95, capacity: 100 },
]
...
export const parkingZones = [
  {
    ...
    slotsFree: 45,
    capacity: 150,
    amenities: ['Covered parking', 'Security', 'Helmet storage'],
  },
  {
    id: 'four-wheeler',
    title: 'Four Wheeler',
    ...
    slotsFree: 28,
    capacity: 100,
    amenities: ['Multi-level', 'EV charging', 'Valet service'],
  },
  {
    id: 'wheelchair-van',
    ...
    slotsFree: 8,
    capacity: 20,
    amenities: ['Accessible ramps', 'Priority parking', 'Assistance available'],
  },
]
